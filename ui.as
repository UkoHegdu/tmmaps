...
void RenderTrackGenerator()
{
	...
	*/
	...
	UI::SameLine();
	UI::TextDisabled("Writes all default block IdNames to the OpenPlanet log file.");
	...
	UI::Separator();
	UI::Text("\\$999\\$sTrack Generator 1.0.0 | Based on \\$bbbAvondaleZPR\\$999 | Maintained by \\$bbbYOUR_NAME\\$999 " + Icons::Copyright);
}
